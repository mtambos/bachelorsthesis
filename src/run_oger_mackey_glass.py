...
if __name__ == '__main__':
    ...
    if '--amgng_file' in args:
        ...
        amgng_file = 'experiments/oger/mackey_glass-1000_samples_1d_final.csv'
    if '--do_cla' in args:
        do_cla = True
    else:
        do_cla = False
    if '--cla_file' in args:
        ...
        cla_file = 'experiments/oger/mackey_glass-1000_samples_1d_final.csv'
    if '--cwd' in args:
